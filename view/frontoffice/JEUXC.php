...
<body>
    ...
    <div class="quiz-container">
        ...
        <div class="question">
            <p>3. Quelle fonction C est utilisée pour lire une chaîne de caractères ?</p>
            <div class="input-container">
        ...
        <div class="question">
            <p>6. Quelle fonction est utilisée pour obtenir la taille d'une variable en mémoire ?</p>
            <div class="input-container">
        ...
        <div class="question">
            <p>8. Quelle structure de contrôle est utilisée pour exécuter un bloc de code plusieurs fois ?</p>
            <div class="input-container">
        ...
        <div class="question">
            <p>9. Quelle fonction permet d'obtenir un nombre entier aléatoire ?</p>
            <div class="input-container">
        ...
        <div class="question">
            <p>10. Quelle bibliothèque est incluse pour manipuler des chaînes de caractères en C ?</p>
            <div class="input-container">
    ...
    <script>
        const correctAnswers = {
            'question1': 'printf',  // Afficher un message
            'question2': 'malloc',  // Allouer de la mémoire
            'question3': 'gets',    // Lire une chaîne de caractères
            'question4': 'fopen',   // Ouvrir un fichier
            'question5': 'free',    // Libérer de la mémoire
            ...
            'question10': 'string.h'// Bibliothèque pour les chaînes
        };
