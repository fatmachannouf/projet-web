<?php 
  ...
  function GetTacheOfCour($ID){
    $db = config::getConnexion();
        $stmt = $db->prepare("Select * from tache where ID_COURS = :ID;");
              ...
              <?php foreach($Cours as $Cour):?> 
                <div class="item">
                  <div class="service-item">
                    <div class="icon">
                      <img src="<?php echo $Cour['Image'];?>" alt="<?php echo $Cour['NOM_COURS'];?>" width="" height="">
                    </div>
                    <h4> Cour <?php echo $Cour['NOM_COURS'];?></h4>
                    <?php $Taches = GetTacheOfCour($Cour['ID_COURS']) ?>
                    <ul>
                    <?php if($Taches):?>
                      <?php foreach($Taches as $Tache):?>
                        <li><?php echo $Tache['DES_TACHE'];?></li>
                      <?php endforeach;?> 
                    <?php else:?>
                      <p>Coming Soon !!</p>
                    <?php endif;?>
