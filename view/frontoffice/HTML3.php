...
<head>
    ...
    <title>Chapitre 3 : Création de Formulaires et Tableaux</title>
    <!-- CSS Links -->
...
<body>
    <header>
        <h1>Chapitre 3 : Création de Formulaires et Tableaux</h1>
    </header>
    <main>
        <section>
...
<table border="1">
    ...
    <section>
        <div class="button-container">
            <a href="HTML2.php">Précédent</a>
            <a href="HTML4.php">Suivant</a>
