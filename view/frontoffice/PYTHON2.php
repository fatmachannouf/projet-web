<!-- Chapitre 2: Fonctions et Structures de Données -->
<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
...
<body>
    <h1>Chapitre 2 : Fonctions et Structures de Données</h1>
    <h2>1. Fonctions</h2>
    <p>Les fonctions permettent de structurer le code :</p>
    <pre><code>def ajouter(a, b):
    return a + b

print(ajouter(5, 3))</code></pre>

    <h2>2. Paramètres et valeurs de retour</h2>
    <p>Une fonction peut avoir des paramètres optionnels :</p>
    <pre><code>def saluer(nom="inconnu"):
    print(f"Bonjour, {nom}!")</code></pre>

    <h2>3. Structures de données</h2>
    <ul>
        <li><strong>Listes :</strong> <code>[1, 2, 3]</code></li>
        <li><strong>Tuples :</strong> <code>(1, 2, 3)</code></li>
