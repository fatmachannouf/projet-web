...
<head>
    ...
    <title>Chapitre 4 : Concepts avancés du C : Pointeurs et Structures</title>
...
<body>
    <h1>Chapitre 4 : Concepts avancés du C : Pointeurs et Structures</h1>
    ...
    <section>
        ...
        <ul>
            ...
            <li>Allocation dynamique de mémoire (<code>malloc</code>, <code>free</code>)</li>
        </ul>
    </section>
    ...
    <section>
        ...
        <ul>
            ...
            <li>Fonctions standard de manipulation de chaînes (<code>strlen</code>, <code>strcpy</code>, etc.)</li>
        </ul>
    </section>

    <div class="button-container">
        <a href="C3.php">Précédent</a>
        <a href="C5.php">Suivant</a>
