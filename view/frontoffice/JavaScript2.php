...
<head>
    ...
    <title>Chapitre 2 : Fonctions et manipulation des données</title>
    <!-- CSS Links -->
...
<body>
    <h1>Chapitre 2 : Fonctions et manipulation des données</h1>

    <section>
        <h2>1. Déclaration et appel de fonctions</h2>
        <p>Une fonction en JavaScript peut être déclarée de cette manière :</p>
        <pre>
function ajouter(a, b) {
    return a + b;
}
        </pre>
        <p>Et appelée ainsi :</p>
        <pre>
let result = ajouter(5, 3);
        </pre>
    </section>

    <section>
        <h2>2. Fonctions fléchées</h2>
        <p>Les fonctions fléchées offrent une syntaxe plus concise :</p>
        <pre>
const ajouter = (a, b) => a + b;
    ...
    <section>
        <h2>3. Tableaux et objets : manipulation et itération</h2>
        <p>Voici un exemple de tableau et de son itération :</p>
        <pre>
...
fruits.forEach(fruit => {
    ...
    <section>
        <div class="button-container">
            <a href="JavaScript1.php">Précédent</a>
            <a href="JavaScript3.php">Suivant</a>
