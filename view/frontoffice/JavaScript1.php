...
<head>
    ...
    <title>Chapitre 1 : Fondamentaux de JavaScript</title>
    <!-- CSS Links -->
...
<body>
    <h1>Chapitre 1 : Fondamentaux de JavaScript</h1>
...
const pi = 3.14;
    ...
    <section>
        <div class="button-container">
            <a href="JavaScript.php">Précédent</a>
            <a href="JavaScript2.php">Suivant</a>
