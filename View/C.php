...
<body>
    ...
    <section>
        <h2>Bibliothèques standard</h2>
        <ul>
            <li>Utilisation des bibliothèques standard C (stdio.h, stdlib.h, math.h, string.h, etc.)</li>
            <li>Fonctions d'entrée/sortie, mathématiques, gestion de mémoire</li>
        </ul>
    </section>

    <section>
        <h2>Pratiques de programmation en C</h2>
        <ul>
    ...
    <section>
        <h2>Programmation avancée (optionnelle)</h2>
        <ul>
