...
<head>
    ...
    <title>Chapitre 5 : Optimisation et transactions</title>
    <!-- CSS Links -->
...
<h1>Chapitre 5 : Optimisation et transactions</h1>

<section>
    <h2>Indexation</h2>
    <p>Les index sont utilisés pour améliorer la vitesse des requêtes SELECT en permettant une recherche plus rapide dans les tables.</p>
    <pre><code>CREATE INDEX idx_column_name ON table_name (column_name);</code></pre>
</section>

<section>
    <h2>Gestion des transactions</h2>
    <h3>Contrôle des transactions avec <code>BEGIN</code>, <code>COMMIT</code>, et <code>ROLLBACK</code></h3>
    <p>Les transactions permettent de grouper plusieurs opérations SQL en une seule unité de travail.</p>
    <pre><code>BEGIN;
    SQL statements;
    COMMIT;
...
<section>
    ...
    <p>Analyser les requêtes et optimiser les index peut améliorer la performance des bases de données. Utiliser <code>EXPLAIN</code> pour analyser les requêtes.</p>
    <pre><code>EXPLAIN SELECT * FROM table_name;</code></pre>
</section>
    <section>
    <div class="button-container">
        <a href="SQL4.php">Précédent</a>
        <a href="JEUXSQL.php">Suivant</a>
