<!-- Chapitre 3: Gestion des erreurs et exceptions -->
<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
...
<body>
    <h1>Chapitre 3 : Gestion des erreurs et exceptions</h1>
    <h2>1. Bloc try/except</h2>
    <p>En Python, le bloc <code>try</code> est utilisé pour gérer les erreurs potentielles :</p>
    <pre><code>try:
    ...
    print("Division par zéro non autorisée.")</code></pre>

    <h2>2. Lever des exceptions personnalisées</h2>
    <p>Vous pouvez lever vos propres exceptions avec <code>raise</code> :</p>
    <pre><code>def verifier_age(age):
    if age < 18:
...
try:
    ...
    <h2>3. Gestion des erreurs</h2>
    <p>Le bloc <code>finally</code> s'exécute toujours, qu'il y ait une exception ou non :</p>
    <pre><code>try:
