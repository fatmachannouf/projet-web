...
.button-container input[type="reset"] {
    background-color: pink; /* Couleur de fond rose */
...
<body>
              ...
              <div class="col-12">
                  <nav class="main-nav">
                      ...
                      <a href="index.html" class="logo">
                        <img src="Learnora.png"  alt="LEARNORA" width="80px" height="80px">
                          <span class="site-name">LEARNORA</span>
                      </a>
                      <!-- ***** Logo End ***** -->
                      <!-- ***** Menu Start ***** -->
                      <ul class="nav">
          ...
          <div class="owl-service-item owl-carousel">
            <div class="item">
              <div class="service-item">
                <div class="icon">
                  <a href="HTML.php">
                    <img src="HTML.jpg" alt="HTML" width="60%">
                  </a>
                </div>
                <h4>HTML</h4>
            ...
            <div class="item">
              <div class="service-item">
                ...
                <h4>MySQL</h4>
                <p>MySQL is a widely used relational database management system (RDBMS).
            ...
            <div class="item">
              <div class="service-item">
                ...
                <p>C++ is a popular programming language.
                   ...
                   C++ was developed as an extension of C, and both languages have almost the same syntax.</p>
              </div>
            </div>
            <div class="item">
              <div class="service-item">
  ...
  <section class="our-services" id="courses">
    <div class="container">
      <div class="row">
