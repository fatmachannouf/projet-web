    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="addCategorie.php">
                        <i class="fas fa-fw fa-tachometer-alt"></i>
                        <span>Add categorie</span></a>
                </li>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Categorie List</h1>
                                  </div>
        ...
        ?> <tr>
         <td><?= $categorie['id']; ?></td>
            ...
            <td>
                <a href="deleteCategorie.php?id=<?php echo $categorie['id']; ?>">Delete</a>
            </td>
            </tr>
        <?php
    }
