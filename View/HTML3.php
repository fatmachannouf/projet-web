...
<head>
    ...
    <title>Création de Formulaires et Tableaux</title>
    <!-- CSS Links -->
...
<body>
    <header>
        <h1>Création de Formulaires et Tableaux</h1>
    </header>
    <main>
        <section>
            <h2>1. Créer un Formulaire</h2>
            <p>Les formulaires permettent de collecter des informations auprès des utilisateurs. Voici comment créer un formulaire HTML simple :</p>
            <pre>
<form action="/submit" method="post">
    ...
    <input type="submit" value="Envoyer">
        ...
        <section>
            <h2>2. Créer un Tableau</h2>
            <p>Les tableaux sont utilisés pour afficher des données sous forme de lignes et de colonnes.</p>
            <pre>
<table border="1">
    <tr>
        <th>Nom</th>
    ...
    <a href="HTML4.php">Passer au Chapitre 4</a> 
</body>
</html>
